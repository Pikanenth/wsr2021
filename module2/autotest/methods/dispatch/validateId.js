...
// Поиск поездок. A8E2 Validation error. Correct body
export default async () => {
    ...
    try {
        ...
        let response = await axios.get(`${ url }/dispatch?from=323232&to=321321321`);
    ...
    try {
        ...
        log.success('Поиск поездок. A8E2 Validation error. Correct body');

    } catch (e) {
        log.error('Поиск поездок. A8E2 Validation error. Correct body');
    }
};